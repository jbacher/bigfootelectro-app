...
class Artist {
  ...
  final String stage = "Main Stage";
  final List<DateTime> performanceTimes; //might use a diff classm have to store begin,end time and venue
  // final String venue; //enum?

  const Artist(this.name, this.performanceTimes);
...
List artistsList = <Artist> [
  Artist("INFEKT", [DateTime.parse("2020-05-22 12:00:04Z"), DateTime.parse("2020-05-23 12:00:04Z")]),
  Artist("JANTSEN", [DateTime.parse("2020-05-22 12:00:04Z")]),
  Artist("PHUTUREPRIMITIVE", [DateTime.parse("2020-05-22 12:30:04Z"), DateTime.parse("2020-05-23 12:30:04Z")]),
